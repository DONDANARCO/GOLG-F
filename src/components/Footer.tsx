        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="flex items-center space-x-2 mb-4">
              ...
              <span className="text-xl font-bold">Golf Club Store</span>
            </div>
            <p className="text-gray-400 mb-6">
              Your premier destination for premium golf equipment. We offer the finest selection 
              of golf clubs from top brands to help you improve your game.
            </p>
          ...
          <div>
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-center space-x-3">
                ...
                <span className="text-gray-400">info@golfclubstore.com</span>
              </div>
            </div>
          </div>
        </div>
